      ...
      <div className="mt-4 grid gap-3 md:grid-cols-3">
        ...
        <div className="rounded-lg border border-sky-300/30 bg-sky-900/20 p-3 text-sm text-sky-100 md:col-span-3">
          ...
          <div className="mt-3 grid gap-2 md:grid-cols-3">
            <p><strong>Total Users:</strong> {userMigrationSummary?.totalUsers ?? '-'}</p>
            <p><strong>Users Needing Update:</strong> {userMigrationSummary?.updatedUsers ?? '-'}</p>
            <p><strong>Admin Code Backfill:</strong> {userMigrationSummary?.adminCodeBackfilled ?? '-'}</p>
          </div>
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <button
              type="button"
              disabled={userMigrationLoading || migrationLoading}
            ...
            >
              Refresh User Migration Summary
            </button>
          </div>
        </div>
