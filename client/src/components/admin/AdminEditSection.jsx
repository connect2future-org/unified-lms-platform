  ...
  return (
    <section className="rounded-2xl border border-blue-300/30 bg-gradient-to-br from-blue-950/45 to-blue-800/25 p-4">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h2 className="text-lg font-black text-blue-100">Edit Section</h2>
              ...
              <tr key={team._id} className="align-top">
                ...
                <td className="px-3 py-3">
                  <button
                    type="button"
                    onClick={() => onEdit(team)}
                    className="rounded-md bg-blue-500 px-3 py-1.5 text-xs font-semibold text-white hover:bg-blue-400"
                  >
                    Edit Team
                  </button>
                </td>
