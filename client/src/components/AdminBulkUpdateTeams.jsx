  ...
  if (loading) {
    return (
      <section className="rounded-2xl border border-blue-300/30 bg-gradient-to-br from-blue-950/45 to-blue-800/25 p-4">
        <h2 className="text-lg font-black text-blue-100">Bulk Update Teams</h2>
        <p className="mt-2 text-sm text-blue-100/90">Loading records...</p>
      </section>
    )
  }
    ...
    <section className="rounded-2xl border border-blue-300/30 bg-gradient-to-br from-blue-950/45 to-blue-800/25 p-4">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-3">
        <div className="md:col-span-2">
          <label htmlFor="target-field" className="mb-1 block text-xs font-bold text-blue-100/90">
            Field To Update
          </label>
          <select
            id="target-field"
            ...
            className="w-full rounded-lg border border-blue-200/40 bg-slate-950/40 px-3 py-2 text-sm text-white outline-none ring-0"
          >
        ...
        <div className="md:col-span-2">
          <label htmlFor="target-value" className="mb-1 block text-xs font-bold text-blue-100/90">
