    ...
    <PageShell>
      <section className="mx-auto grid w-full max-w-5xl gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-3xl border border-white/25 bg-white/10 p-6 shadow-2xl backdrop-blur-xl md:p-8">
          <p className="inline-flex rounded-full border border-blue-400 bg-blue-100 px-3 py-1 text-xs font-bold uppercase tracking-widest text-blue-900">
            Team Access
          </p>
          ...
          <div className="mt-6 inline-flex rounded-full border border-slate-300 bg-slate-100 p-1 text-sm">
            <button
              type="button"
              onClick={() => {
                setMode('login')
              ...
              className={`rounded-full px-4 py-2 font-semibold transition ${
                mode === 'login' ? 'bg-blue-500 text-white' : 'text-slate-700 hover:bg-slate-200'
              }`}
            >
              Sign In
            </button>
            <button
              ...
              className={`rounded-full px-4 py-2 font-semibold transition ${
                mode === 'forgot' ? 'bg-blue-500 text-white' : 'text-slate-700 hover:bg-slate-200'
              }`}
            >
              Forgot Password
            </button>
          ...
          {mode === 'login' ? (
            <form onSubmit={onLoginSubmit} className="mt-6 space-y-4">
              ...
              <div className="flex items-center justify-between gap-3 text-sm">
                <span className="text-slate-700">Use your team credentials to manage access securely.</span>
                <button
                  type="button"
                  onClick={() => setMode('forgot')}
                  className="font-semibold text-blue-600 underline decoration-blue-400 underline-offset-4"
                >
                  Forgot Password?
                </button>
              </div>
        ...
        <aside className="space-y-6">
          <div className="rounded-3xl border border-white/25 bg-white/10 p-6 shadow-2xl backdrop-blur-xl md:p-8">
            <h2 className="text-2xl font-black text-slate-900">Secure Access Rules</h2>
